...
class SdrMigrationTest {
    ...
    void shouldRejectNullFromHash() {
        ...
        IllegalArgumentException exception = assertThrows(
                ...
                () -> new SdrMigration(
                        null, "hash2", "ALTER TABLE test;", 0.9, "Generated by test", "postgres", Instant.now()));
    ...
    void shouldRejectBlankFromHash() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new SdrMigration(
                        "", "hash2", "ALTER TABLE test;", 0.9, "Generated by test", "postgres", Instant.now()));
        assertEquals("fromHash cannot be null or blank", exception.getMessage());
    }
    ...
    void shouldRejectNullToHash() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new SdrMigration(
                        "hash1", null, "ALTER TABLE test;", 0.9, "Generated by test", "postgres", Instant.now()));
    ...
    void shouldRejectBlankToHash() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new SdrMigration(
                        "hash1", "", "ALTER TABLE test;", 0.9, "Generated by test", "postgres", Instant.now()));
        assertEquals("toHash cannot be null or blank", exception.getMessage());
    }
    ...
    void shouldRejectNullMigrationScript() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new SdrMigration("hash1", "hash2", null, 0.9, "Generated by test", "postgres", Instant.now()));
    ...
    void shouldRejectBlankMigrationScript() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new SdrMigration("hash1", "hash2", "   ", 0.9, "Generated by test", "postgres", Instant.now()));
        assertEquals("migrationScript cannot be null or blank", exception.getMessage());
    }
    ...
    void shouldRejectNullDialect() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new SdrMigration(
                        "hash1", "hash2", "ALTER TABLE test;", 0.9, "Generated by test", null, Instant.now()));
    ...
    void shouldRejectBlankDialect() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new SdrMigration(
                        "hash1", "hash2", "ALTER TABLE test;", 0.9, "Generated by test", "", Instant.now()));
        assertEquals("dialect cannot be null or blank", exception.getMessage());
    }
    ...
    void shouldRejectNullCreatedAt() {
        ...
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new SdrMigration(
                        "hash1", "hash2", "ALTER TABLE test;", 0.9, "Generated by test", "postgres", null));
