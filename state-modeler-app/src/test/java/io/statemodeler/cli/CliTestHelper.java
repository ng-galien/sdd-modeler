...
/**
 * Small convenience helpers to make assertions on picocli CommandLine
 * executions easier in tests.
 *
 * <p>
 * Provides a compact API to execute a command and assert on its exit code and
 * outputs with a
