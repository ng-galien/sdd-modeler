    ...
    public Integer call() throws Exception {
        try {
            ...
            if (!DdlGenerators.isSupported(dialect)) {
                log.error("Unsupported SQL dialect '{}'", dialect);
                log.error("Supported dialects: {}", String.join(", ", DdlGenerators.getSupportedDialects()));
                return 1;
            }
            ...
            // Generate DDL
            log.info("Generating DDL for dialect: {}", dialect);
            ...
            if (outputFile != null) {
                ...
                log.info("✓ DDL written to: {}", outputFile);
            } else {
                // Output to stdout
            ...
            log.error("Error generating SQL: {}", e.getMessage());
            if (e.getCause() != null) {
