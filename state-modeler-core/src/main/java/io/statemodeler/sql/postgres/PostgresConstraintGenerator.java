...
final class PostgresConstraintGenerator {
         ...
         */
        List<ConstraintDefinition> generateStateUniqueConstraints(EntityDef entity, StateDef state,
                        String stateSchema) {
                ...
                constraints.add(new ConstraintDefinition(
                                uniqueEntityName, tableName, ConstraintDefinition.ConstraintType.UNIQUE,
                                uniqueEntityDef));
                ...
                constraints.add(new ConstraintDefinition(
                                uniqueCompositeName, tableName, ConstraintDefinition.ConstraintType.UNIQUE,
                                uniqueCompositeDef));
        ...
        List<ConstraintDefinition> generateOrTransitionUniqueConstraints(
                ...
                constraints.add(
                                new ConstraintDefinition(uniqueName, tableName,
                                                ConstraintDefinition.ConstraintType.UNIQUE, uniqueDef));
        ...
        List<ConstraintDefinition> generateStateForeignKeys(
                ...
                var entityFkDef = "FOREIGN KEY (" + entity.name() + "_id) REFERENCES " + entitySchema + "."
                                + entity.table() + "(id)";
                constraints.add(new ConstraintDefinition(
                ...
                if (!state.initial()) {
                        if (state.hasOrTransitions()) {
                                ...
                                constraints.add(new ConstraintDefinition(
                                                orFkName, tableName, ConstraintDefinition.ConstraintType.FOREIGN_KEY,
                                                orFkDef));
                        } else {
                                ...
                                for (var fromState : state.from()) {
                                        ...
                                        var prevFkDef = "FOREIGN KEY (previous_" + fromState + "_id, " + entity.name()
                                                        ...
                                                        + "_id)";
                                        constraints.add(new ConstraintDefinition(
                                                        prevFkName, tableName,
                                                        ConstraintDefinition.ConstraintType.FOREIGN_KEY, prevFkDef));
                                }
                        }
                }
        ...
        List<ConstraintDefinition> generateOrTransitionForeignKeys(
                ...
                for (var fromState : state.fromAnyOf()) {
                        ...
                        constraints.add(new ConstraintDefinition(
                                        constraintName, tableName, ConstraintDefinition.ConstraintType.FOREIGN_KEY,
                                        fkDefinition));
                }
                ...
                for (int i = 0; i < state.fromAnyOf().size(); i++) {
                        for (int j = i + 1; j < state.fromAnyOf().size(); j++) {
                                ...
                                exclusiveConditions.add(
                                                "NOT (" + state1 + "_state_id IS NOT NULL AND " + state2
        ...
        ConstraintDefinition generateExtensionForeignKey(EntityDef entity, ExtensionDef extension, String stateSchema) {
                ...
                return new ConstraintDefinition(fkName, tableName, ConstraintDefinition.ConstraintType.FOREIGN_KEY,
                                fkDef);
        }
        ...
        ConstraintDefinition generateDomainStateForeignKey(EntityDef entity, String entitySchema, String stateSchema) {
                ...
                var fkDef = "FOREIGN KEY (" + entityIdColumn + ") REFERENCES " + entitySchema + "." + entity.table()
                                + "(id)";
                return new ConstraintDefinition(fkName, domainStateTable,
                                ConstraintDefinition.ConstraintType.FOREIGN_KEY, fkDef);
        }
}
